...
export default function App() {
  ...
  const renderDay = (row: ScheduleRow) => {
    const [day, dateStr, weekday, s1, s2, s3, isExtra] = row;
    const padDay = String(day).padStart(2, '0');

    return (
      <div key={day} className={`grid grid-cols-[48px_80px_1fr] sm:grid-cols-[60px_110px_1fr_1fr_1fr] bg-[var(--surface)] border border-[var(--border)] rounded-xl overflow-hidden transition-all duration-150 hover:-translate-y-[1px] hover:border-[#2e3d60] ${isExtra ? 'border-[rgba(251,191,36,0.3)]' : ''}`}>
        <div className="flex flex-col items-center justify-center p-[14px_6px] bg-[var(--surface2)] border-r border-[var(--border)] font-['Space_Mono']">
          <span className="text-[1.2rem] font-bold text-[var(--muted)] leading-none">{padDay}</span>
          <span className="text-[0.52rem] uppercase tracking-[1px] text-[#2d3b5a] mt-[2px]">Day</span>
        </div>
        <div className="flex flex-col justify-center p-[12px_14px] border-r border-[var(--border)]">
  ...
  return (
    <div className="max-w-[1160px] mx-auto">
      ...
      <div className="max-w-[1160px] mx-auto mb-11">
        ...
        <div className="grid grid-cols-[48px_80px_1fr] sm:grid-cols-[60px_110px_1fr_1fr_1fr] mb-2 pb-2 border-b border-[var(--border)]">
          <div className="px-[14px] py-[2px] text-[0.58rem] uppercase tracking-[2px] text-[var(--muted)] font-bold">Day</div>
          <div className="px-[14px] py-[2px] text-[0.58rem] uppercase tracking-[2px] text-[var(--muted)] font-bold">Date</div>
